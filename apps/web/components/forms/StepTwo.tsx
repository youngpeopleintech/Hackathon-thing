...
export function StepTwo({ data, errors, onChange, onNext, onBack }: StepTwoProps) {
  const trackOptions = Object.entries(HACKATHON_TRACK_LABELS).map(([value, label]) => ({
    value,
    label,
  }));
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <RadioGroup
          ...
          onChange={(value) => onChange('hackathonTrack', value as HackathonTrack)}
          columns={2}
